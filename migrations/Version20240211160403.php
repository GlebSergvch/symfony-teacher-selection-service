 ...
 */
final class Version20240211160403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX user__phone__uniq__idx ON "user" (phone)');
        $this->addSql('CREATE UNIQUE INDEX user__email__uniq__idx ON "user" (email)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX user__phone__uniq__idx');
        $this->addSql('DROP INDEX user__email__uniq__idx');
